...
import { searchUsers } from '../apis/searchUsers.js';
import { validUser } from '../apis/validUser.js';
...
import { accessCreate } from "../apis/accessCreate.js";
import "./home.css";
...
import profilePic from "../assets/user-profile.svg";
...
function Home() {
  ...
  const handleClick = async (e) => {
    await accessCreate({ userId: e._id })
    dispatch(fetchChats())
    setSearch("")
  };
                ...
                <div className='h-[61px] px-4'>
                  ...
                  <div className='absolute top-4 right-5 flex items-center gap-x-3'>
                    ...
                    <button onClick={() => dispatch(setShowProfile(true))} className='flex items-center gap-x-1 relative'>
                      <img className='w-[28px] h-[28px] rounded-[25px]' src={profilePic} alt="" />
